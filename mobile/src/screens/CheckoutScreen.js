...
const s = StyleSheet.create({
  ...
  badgeText: { ...typography.caption, fontFamily: 'Inter_600SemiBold', color: colors.textPrimary },
  ...
  statusText: { ...typography.caption, color: colors.forestGreen, fontFamily: 'Inter_600SemiBold', textAlign: 'center' },
