...
const s = StyleSheet.create({
  ...
  countText: { fontFamily: 'Poppins_700Bold', fontSize: 11, color: colors.textPrimary },
  ...
  sortText: { ...typography.caption, fontFamily: 'Poppins_500Medium', color: colors.textSecondary },
  ...
  toggleText: { ...typography.caption, fontFamily: 'Poppins_500Medium', color: colors.textSecondary },
