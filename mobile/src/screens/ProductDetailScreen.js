...
const s = StyleSheet.create({
  ...
  stockPillText: { ...typography.caption, fontFamily: 'Poppins_600SemiBold', color: colors.status.cancelled },
  ...
  perUnit: { ...typography.body, color: colors.textMuted, fontFamily: 'Poppins_400Regular' },
  bulkSave: { backgroundColor: colors.harvestGoldLight, borderRadius: radius.pill, paddingHorizontal: 10, paddingVertical: 4 },
  bulkSaveText: { ...typography.caption, fontFamily: 'Poppins_600SemiBold', color: colors.harvestGoldDark },
  ...
  avatarText: { color: colors.white, fontFamily: 'Poppins_700Bold', fontSize: 13 },
  ...
  verifiedText: { fontSize: 11, fontFamily: 'Poppins_600SemiBold', color: colors.forestGreen },
  ...
  subtotalQty: { ...typography.body, color: colors.textMuted, fontFamily: 'Poppins_400Regular' },
  ctaBar: {
