...
const s = StyleSheet.create({
  ...
  liveText: { ...typography.caption, fontFamily: 'Poppins_600SemiBold', color: colors.white, fontSize: 11 },
  ...
  filterText: { ...typography.caption, fontFamily: 'Poppins_500Medium', color: colors.textSecondary, textTransform: 'capitalize' },
