...
const s = StyleSheet.create({
  ...
  type: { ...typography.caption, fontFamily: 'Poppins_600SemiBold', color: colors.textMuted, flex: 1 },
  unreadPill: { backgroundColor: colors.harvestGold, borderRadius: radius.pill, paddingHorizontal: 6, paddingVertical: 2 },
  unreadText: { ...typography.caption, fontFamily: 'Poppins_700Bold', color: colors.textPrimary, fontSize: 10 },
