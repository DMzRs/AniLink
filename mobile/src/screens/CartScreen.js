...
const s = StyleSheet.create({
  ...
  itemPrice: { ...typography.caption, color: colors.forestGreen, fontFamily: 'Inter_600SemiBold' },
  ...
  pillText: { ...typography.caption, fontFamily: 'Inter_600SemiBold', color: colors.textSecondary },
